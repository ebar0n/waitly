/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 39065949ff95accdf67468a100244136)
// Runtime types generated with workerd@1.20260317.1 2026-02-24 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CommentBoard";
	}
	interface Env {
		...
		COMMENT_BOARD: DurableObjectNamespace<import("./src/index").CommentBoard>;
		ONBOARDING_WORKFLOW: Workflow<Parameters<import("./src/index").OnboardingWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CORS_ORIGIN" | "JWT_SECRET" | "ADMIN_SECRET" | "TURNSTILE_SECRET_KEY">> {}
}
